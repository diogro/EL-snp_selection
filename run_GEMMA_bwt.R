...
gwas_rsnp = ldply(1:20, function(i) read_tsv(paste0("~/Media/external/output/bwt_r-snp_chr",i,".assoc.txt")))
gwas_rsnp_loco = ldply(1:20, function(i) read_tsv(paste0("~/Media/external/output/bwt_r-LOCO_snp_chr",i,".assoc.txt")))
gwas_rped = ldply(1:20, function(i) read_tsv(paste0("~/Media/external/output/bwt_r-ped_chr",i,".assoc.txt")))
